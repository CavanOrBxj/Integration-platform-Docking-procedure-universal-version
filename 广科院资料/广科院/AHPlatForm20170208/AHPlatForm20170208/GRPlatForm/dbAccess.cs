...
namespace GRPlatForm
{
    public class dbAccess
    {
        ...
        ////设置conn
        //public void SetConnStr(string sConn)
        //{
        //    try
        //    {
        //        if (sConn.Trim().Length == 0)
        //            return;
        //        this.conn.ConnectionString = sConn;
        //    }
        //    catch
        //    {
        //        throw;
        ...
        public bool InsertData(string strSql, SqlParameter[] parameters)
        {
            ...
            //object obj = SQLHelper.ExecuteNonQuery(SQLHelper.CONN_STRING, CommandType.Text, strSql.ToString(), parameters);
        ...
        public int loginJudge(string sCode, string sUser, string sPass, dbAccess dba)
        {
            ...
            String sLog = "Select count(1) as usercount from users where user_code ='"
                        ...
                        + "' and user_pwd = '" + sPass + "'";
            //MD5InEntry(sPass)
            //return (int)getQueryResultBySQL(sLog);
